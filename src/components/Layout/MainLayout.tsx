...
export function MainLayout({ children }: IMainLayout) {
  return (
    <div className="relative flex flex-col mx-auto w-full md:w-full overflow-x-hidden flex-1 justify-between scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-300 dark:scrollbar-thumb-gray-600 dark:scrollbar-track-gray-800">
